				...
				\subparagraph{Pouvoir du bailleur} Le bailleur doit avoir le pouvoir de
					...
					\begin{enumerate}
						...
						Concernant le \textbf{bailleur indivisaire},
							...
							\jurisCourDeCas*[16-13063]{\civTrois}{16/03/2017}

						\item Lorsque le \textbf{bailleur est marié}, il faut distinguer selon le régime matrimonial.
						Dans le régime de la séparation de bien, si le bien loué est un bien personnel, propre, \articleDu{1425}{\cciv}

							Si l’immeuble est un bien propre liberté sauf art 215 al 3 CC

							Si l’immeuble est un bien commun
							\begin{itemize}
								\item art 1425 CC accord des deux époux pour baux ruraux et
								commerciaux
